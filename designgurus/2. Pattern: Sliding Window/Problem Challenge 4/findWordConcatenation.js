findWordConcatenation = (str, words) => {
    ...
    for (i = 0; i < (str.length - wordsCount * wordLength) + 1; i++) {
        ...
        for (j = 0; j < wordsCount; j++) {
            ...
            wordsSeen[word] += 1;
            console.log('wordsSeen',wordsSeen)
...
console.log(findWordConcatenation('catfoxcatfox', ['cat', 'fox']))
console.log(findWordConcatenation('catcatfoxfoxcatcatfoxfox', ['cat', 'fox']))